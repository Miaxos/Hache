...
Le projet s’est révélé très enrichissant, il nous a permis de découvrir
...
\newline
\newline
Les principaux problèmes, que nous avons rencontrés, concernaient  la
conception initiale du projet, nous avant directement commencé par le
code. Ainsi, j'ai eu au début quelques problèmes en utilisant le git sous
windows.
\bigskip
\starbreak
\section{Axel JUGUET}
